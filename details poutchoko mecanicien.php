...
<body>
    <div class="container">
        ...
        <div class="info-group">
            <p><span class="info-label">Mécanicien:</span> Poutchoko miguel</p>
            <p><span class="info-label">Spécialité:</span> Électricité auto</p>
            <p><span class="info-label">Expérience:</span> 5 ans</p>
        </div>
        
        <div class="info-group">
            <p><span class="info-label">Date de l'intervention:</span> 03/09/2024</p>
            <p><span class="info-label">Heure de début:</span> 14:30</p>
            <p><span class="info-label">Statut:</span> <span class="status status-en-cours">En intervention</span></p>
        </div>
