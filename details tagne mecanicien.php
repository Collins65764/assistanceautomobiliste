...
<body>
    <div class="container">
        ...
        <div class="info-group">
            <p><span class="info-label">Mécanicien:</span> Tagne Jean</p>
            <p><span class="info-label">Spécialité:</span> Pneumatiques</p>
            <p><span class="info-label">Expérience:</span> 3 ans</p>
        </div>
        
        <div class="info-group">
            <p><span class="info-label">Date de l'intervention:</span> 02/07/2024</p>
            <p><span class="info-label">Heure de début:</span> 11:30</p>
